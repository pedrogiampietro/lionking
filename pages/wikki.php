...
$main_content .= '
    <ul class="wiki_menu">
        <img class="wiki_logo" src="' . $layout_name . '/images/global/header/tibia-logo-artwork-top-warmen-production.png">
        <!--
...
$main_content .= '
        ...
        <div class="wiki_text" id="div-wiki-61">
            <img class="wiki_logo" src="' . $layout_name . '/images/global/header/tibia-logo-artwork-top_warmen.png">
