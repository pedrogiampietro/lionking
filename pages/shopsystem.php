...
if ($config['site']['shop_system'] == 1) {
    ...
    if ($action == '') {
        ...
        $main_content .= $make_double_archs('Welcome to ' . $config['server']['serverName'] . ' Shop.');
        $main_content .= '<br>';
																								...
																								<tr>
																									<td style="border: 0px none;">
																										<div class="BigButton" style="background-image: url(' . $layout_name . '/images/global/buttons/sbutton.gif);">
																											...
																											<input class="ButtonText" name="Continue" alt="Continue" src="' . $layout_name . '/images/global/buttons/_sbutton_purchase.gif" type="image">
																										</div>
																									</div>
																								</td>
																							</tr>
...
';
                if (file_exists('/images/items/' . $itemvip['item_id'] . '.gif')) {
                    $main_content .= '<br /><img src="/images/items/' . $itemvip['item_id'] . '.gif" height="32" width="32"><br /> ';
                } else {
                    $main_content .= '<br /> <img src="images/monsters/nophoto.png" height="32" width="32">';
                }
                $main_content .= '</td>
...
//show list of items offers
        if (!empty($offer_list['item']) or !empty($offer_list['itemlogout'])) {
            $main_content .= '
<div class="TableContainer">
<div class="CaptionContainer">
<div class="CaptionInnerContainer">
...
<td valign="middle" align="center">';
                    if (file_exists('images/items/' . $item['item_id'] . '.gif')) {
                        $main_content .= '<br /><img src="images/items/' . $item['item_id'] . '.gif" height="32" width="32"><br /> ';
                    } else {
                        $main_content .= '<br /> <img src="images/monsters/nophoto.png" height="32" width="32">';
                    }
                    $main_content .= '
...
<div class="TableBottomRightShadow" style="background-image:url(' . $layout_name . '/images/content/table-shadow-br.gif);"></div>
        ...
        if (!empty($offer_list['outfit'])) {

            $main_content .= "<div class='TableContainer'>";
            $main_content .= $make_content_header("Outfits");
...
//            $main_content .= "</div>";
            ...
            if (!empty($offer_list['outfit'])) {
                foreach ($offer_list['outfit'] as $outfit) {
                    ...
                    if (file_exists('images/outfits/' . $outfit['name'] . '_male.gif')) {
                        $main_content .= '<img src="images/outfits/' . $outfit['name'] . '_male.gif"">';
                        $main_content .= '<img src="images/outfits/' . $outfit['name'] . '_female.gif"">';
                    } else {
...
//show list of containers offers
        ...
        if (!empty($offer_list['itemlogout'])) {
            $main_content .= '
<div class="TableContainer">
<div class="CaptionContainer">
<div class="CaptionInnerContainer">
...
<td valign="middle">&nbsp;</td>
            ...
            foreach ($offer_list['container'] as $container) {
                ...
                $number_of_rows++;
                $main_content .= '<tr bgcolor="' . $bgcolor . '"><td valign="middle" align="center">';
                if (file_exists('/images/items/' . $container['item_id'] . '.gif')) {
                    $main_content .= '<img src="/images/items/' . $container['item_id'] . '.gif" height="32" width="32">';
                } else {
...
<div class="TableBottomRightShadow" style="background-image:url(' . $layout_name . '/images/content/table-shadow-br.gif);"></div>
        ...
        if (!empty($offer_list['changename']) or !empty($offer_list['redskull']) or !empty($offer_list['unban'])) {
            $main_content .= '
<div class="TableContainer">
<div class="CaptionContainer">
<div class="CaptionInnerContainer">
...
<div id="BackgroundContainerCenterImage" style="background-image:url(' . $layout_name . '/images/global/content/progressbar/stonebar-center.gif);" />
</div>
</div>
...
<img id="TubeRightEnd" src="' . $layout_name . '/images/global/content/progressbar/progress-bar-tube-right-' . $color1 . '.gif" />
...
<div class="TubeContainer" ><img class="Tube" src="' . $layout_name . '/images/global/content/progressbar/progress-bar-tube-' . $color2 . '.gif" /></div><div class="SingleStepContainer" ><img class="StepIcon" src="' . $layout_name . '/images/global/content/progressbar/progress-bar-icon-3-' . $color3 . '.gif" /><div class="StepText" style="font-weight:normal;" >Confirm Data</div>
</div></div><div class="Steps" style="width:50%" ><div class="TubeContainer" ><img class="Tube" src="' . $layout_name . '/images/global/content/progressbar/progress-bar-tube-' . $color4 . '.gif" /></div><div class="SingleStepContainer" ><img class="StepIcon" src="' . $layout_name . '/images/global/content/progressbar/progress-bar-icon-4-' . $color5 . '.gif" />
...
<td width="100"><b>Image:</b></td><td width="550">';
                            ...
                            elseif ($buy_offer['type'] == 'outfit')
                                if (file_exists('images/outfits/' . $buy_offer['name'] . '_male.gif')) {
                                    $main_content .= 'images/outfits/' . $buy_offer['name'] . '_male.gif"">';
                                    $main_content .= 'images/outfits/' . $buy_offer['name'] . '_female.gif"">';
                                } else {
                                    $main_content .= '<img src="' . $layout_name . '/images/items/notfound.gif">';
                                }
...
<tr bgcolor="#F1E0C6"><td width="100"><b>Product:</b></td><td width="550">';
                            ...
                            $main_content .= '<tr bgcolor="#F1E0C6"><td width="100"><b>Cost:</b></td><td width="550"><small><b>' . $buy_offer['points'] . '</b> warmen-coins</small></td></tr>';
                            $main_content .= '
</table>
</td>
</tr>
...
<TR BGCOLOR=' . $config['site']['darkborder'] . '><TD>To buy <b>' . $buy_offer['name'] . '</b> you need <b>' . $buy_offer['points'] . ' warmen-coins</b>.<br />Your balance is currently <b>' . $user_premium_points . '</b> warmen-coins.</TD>
</TR>
</TABLE>
<br />
<table width="100%">
...
<div class="BigButton" style="background-image: url(' . $layout_name . '/images/global/buttons/sbutton.gif);">
<div onmouseover="MouseOverBigButton(this);" onmouseout="MouseOutBigButton(this);"><div class="BigButtonOver" style="background-image: url(' . $layout_name . '/images/global/buttons/sbutton_over.gif);"></div>
<div class="ButtonText" style="background-image:url(' . $layout_name . '/images/global/buttons/_sbutton_buypoints.png);"></div>
</div>
</div>
</a>
</td>
...
<tr>
<td style="border: 0px none;">
<a href="javascript:void();" onclick=location.href="index.php?subtopic=shopsystem"><div class="BigButton" style="background-image: url(' . $layout_name . '/images/global/buttons/sbutton.gif);">
<div onmouseover="MouseOverBigButton(this);" onmouseout="MouseOutBigButton(this);"><div class="BigButtonOver" style="background-image: url(' . $layout_name . '/images/global/buttons/sbutton_over.gif); visibility: hidden;"></div>
<input class="ButtonText" name="Back" alt="Back" src="' . $layout_name . '/images/global/content/progressbar/_sbutton_back.gif" type="image">
</table>
</td>
</tr>
</tbody>
...
<td width="550"><input type="text" name="buy_from" id="buy_from" style="padding: 5px;" />&nbsp;';
                        if ($account_logged->getCustomField("coins") <= $buy_offer['points']) {
                            $main_content .= '<input type="submit" value="New Name" class="btn disabled btn-danger" disabled />';
                        } else {
                            $main_content .= '<input type="submit" value="New Name" class="btn btn-success"/>';
                        }
                                ...
                                if ($buy_player->isLoaded()) {
                                    ...
                                    if ($_SESSION['viewed_confirmation_page'] == 'yes' && $_POST['buy_confirmed'] == 'yes') {
                                        if ($buy_offer['type'] == 'pacc') {
                                            ...
                                            $SQL->query("UPDATE `accounts` SET `coins` = '$anyThing' WHERE `name` = '$nomedoCara'");
                                            $user_premium_points = $user_premium_points - $buy_offer['points'];
                                            if ($player_vip_days >= 1) {
                                            }
                                            $main_content .= '<center><h2>Premium Days added!</h2><b>' . $buy_offer['days'] . ' days</b> of VIP days added to the account of player <b>' . $buy_player->getName() . '</b> for <b>' . $buy_offer['points'] . ' warmen-coins</b> from your account.<br />Now you have <b>' . $user_premium_points . ' warmen-coins</b>.<br /><br /><a href="index.php?subtopic=shopsystem">Go to Shop Site</a><br />';
                                        } elseif ($buy_offer['type'] == 'unban') {
                                            ...
                                            if ($datadata['value'] == $my_acc_id) {
                                                ...
                                                $account_logged->setCustomField('coins', $user_premium_points - $buy_offer['points']);
                                                $user_premium_points = $user_premium_points - $buy_offer['points'];
                                                ...
                                                $SQL->query($save_transaction);
                                                $main_content .= '<center><h2>Ban Deleted!</h2><b>Your account has been unbanned for ' . $buy_offer['points'] . ' warmen-coins</b> from your account.
<br>Now you have <b>' . $user_premium_points . ' warmen-coins</b>.<br><br><a href="index.php?subtopic=shopsystem">Go to Shop Site</a><br>';
                                            } else {
...
<input class="ButtonText" name="Back" alt="Back" src="' . $layout_name . '/images/global/buttons/_sbutton_back.gif" type="image">
</form>
</div>
</div>
</td>
                                            ...
                                            if ($playerinfo['online'] == '0') {
                                                if ($playerslot['pid'] != '10') {
                                                    if ($datadata['cap'] >= $SQL->quote($buy_offer['free_cap'])) {
                                                        ...
                                                        $account_logged->setCustomField('coins', $user_premium_points - $buy_offer['points']);
                                                        $user_premium_points = $user_premium_points - $buy_offer['points'];
                                                        $main_content .= '<h2>Item received to player: ' . $buy_player->getName() . '!</h2><br />Now you have <b>' . $user_premium_points . ' warmen-coins</b>.
<br /><a href="index.php?subtopic=shopsystem">Go to Shop Site</a>';
                                        ...
                                        elseif ($buy_offer['type'] == 'changename') {
                                            ...
                                            if (empty($newchar_errors)) {
                                                ...
                                                $charToEdit->save();
                                                $account_logged->setCustomField('coins', $account_logged->getCustomField('coins') - $buy_offer['points']);
...
<TR BGCOLOR=' . $config['site']['darkborder'] . '>
<TD>
Item was sent to the player <b>' . $buy_player->getName() . '</b> for <b>' . $buy_offer['points'] . ' warmen-coins</b> from your account.<br />
Now you have <b>' . $user_premium_points . ' warmen-coins</b>.
</TD>
</TR>
</TABLE>
...
<TR BGCOLOR=' . $config['site']['darkborder'] . '>
<TD>
The <b>' . $buy_offer['name'] . '</b> outfits was sent to the player <b>' . $buy_player->getName() . '</b> for <b>' . $buy_offer['points'] . ' warmen-coins</b> from your account.<br />
Now you have <b>' . $user_premium_points . ' warmen-coins</b>.
</TD>
</TR>
</TABLE>
...
//////////////////////////////
                                        if ($buy_offer['type'] == 'vipdays') {
                                            ...
                                            $main_content .= '<center><h2>VIP Days added!</h2><b>' . $buy_offer['days'] . ' days</b> of VIP days added to the account of player <b>' . $buy_player->getName() . '</b> for <b>' . $buy_offer['points'] . ' warmen-coins</b> from your account.<br />Now you have <b>' . $user_premium_points . ' warmen-coins</b>.<br /><br /><a href="index.php?subtopic=shopsystem">Go to Shop Site</a><br />';
                                        } elseif ($buy_offer['type'] == 'itemvip') {
                                            ...
                                            $account_logged->setCustomField('coins', $user_premium_points - $buy_offer['points']);
                                            $user_premium_points = $user_premium_points - $buy_offer['points'];
                                            $main_content .= '<center><h2>Mega Item added!</h2><b>' . $buy_offer['name'] . '</b> added to player <b>' . $buy_player->getName() . '</b> for <b>' . $buy_offer['points'] . ' warmen-coins</b> from your account.<br>Now you have <b>' . $user_premium_points . ' warmen-coins</b>.<br><br><a href="index.php?subtopic=shopsystem">GO TO MAIN SHOP SITE</a><br>';
                                            ...
                                            $account_logged->setCustomField('coins', $user_premium_points - $buy_offer['points']);
                                            $user_premium_points = $user_premium_points - $buy_offer['points'];
                                            $main_content .= '<center><h2>Container of items added!</h2><b>' . $buy_offer['name'] . '</b> added to player <b>' . $buy_player->getName() . '</b> for <b>' . $buy_offer['points'] . ' warmen-coins</b> from your account.<br />Now you have <b>' . $user_premium_points . ' warmen-coins</b>.<br /><br /><a href="index.php?subtopic=shopsystem">GO TO MAIN SHOP SITE</a><br />';
                                        }
                                    } else {
                                        if ($buy_offer['type'] != 'changename') {
                                            $set_session = TRUE;
                                            ...
                                            if ($_REQUEST['action'] == 'confirm_transaction') {
                                                $color1 = 'blue';
                                                $color2 = 'green';
                                                $color3 = 'green';
                                                $color4 = 'green-blue';
...
<tr bgcolor="' . $config['site']['darkborder'] . '">
<td><b>Cost:</b></td>
<td width="550" colspan="2"><b>' . $buy_offer['points'] . ' warmen-coins</b> from your account</td>
</tr>';
                                            $main_content .= '
...
<tr bgcolor="#D4C0A1"><td width="130"><b>Cost:</b></td><td width="550" colspan="2"><b>' . $buy_offer['points'] . ' warmen-coins</b></td></tr>
...
<tr BGCOLOR=' . $config['site']['darkborder'] . '>
<td>For this item you need <b>' . $buy_offer['points'] . '</b> points. You have only <b>' . $user_premium_points . '</b> warmen-coins. Please <a href="index.php?subtopic=shopsystem">select other item</a> or buy warmen-coins.</td>
</tr>
</TABLE>';
                        }
                    } else {
...
if (!$logged) {
    ...
    if ($account_logged->getCustomField("coins") <= 0)
        $main_content .= '<br /><center><div class="error"><b>You do not have warmen-coins available.</b><br /><br /><form action="index.php?subtopic=donate" method="post"><input type="submit" value="Buy now Premium Points here!" class="btn btn-success" /></form></div></center>';
    else {
        if ($account_logged->getCustomField("coins") >= 1) {
            $main_content .= '<br /><center><div class="success" style="width: 300px;">You have&nbsp;<b>' . $account_logged->getCustomField("coins") . '</b>&nbsp;warmen-coins available</div></center>';
        } else {
            $main_content .= '
                <div class="error">
                    Shop for disabled the internal maintenance, back in a moment with our standard systems.
                    <br /><br />
                    <b><small>Graciously, Staff</small></b>
                </div>';
        }
    }
}
