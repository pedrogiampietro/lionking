...
<TR>
    <TD style="vertical-align:top; padding-right: 5px;">
            ...
            <table class="Table1" cellpadding="0" cellspacing="0">
                <div class="CaptionContainer">
                    <div class="CaptionInnerContainer">
                        ...
                        <span class="CaptionBorderTop" style="background-image:url(' . $layout_name . '/images/global/content/table-headline-border.gif);"></span>
                        <span class="CaptionVerticalLeft" style="background-image:url(' . $layout_name . '/images/global/content/box-frame-vertical.gif);" /></span>
                        <div class="Text">Guild Events</div>
                        <span class="CaptionVerticalRight" style="background-image:url(' . $layout_name . '/images/global/content/box-frame-vertical.gif);" /></span>
                        <span class="CaptionBorderBottom" style="background-image:url(' . $layout_name . '/images/global/content/table-headline-border.gif);"></span>
                        <span class="CaptionEdgeLeftBottom" style="background-image:url(' . $layout_name . '/images/global/content/box-frame-edge.gif);" /></span>
                        <span class="CaptionEdgeRightBottom" style="background-image:url(' . $layout_name . '/images/global/content/box-frame-edge.gif);" /></span>
                                    ...
                                    <tr style="background-image: url(./layouts/tibiacom/images/global/content/scroll.gif)!important;">
                                        <td style="padding-right: 5px;">
                                            <table width="100%" class="Table30">
                                                <tbody><tr>
                                                            <td>
                                                                <h4>Como funciona a Guild Events?</h4>
                                                                <p>Bla bla bla bla bla bla bla bla bla mata gente e bla bla bla bla bla bla bla bla </p>
                                                                <p>Fica fortão e bla bla bla bla bla bla bla gasta com coisas e bla bla bla bla .</p>
		...
		$expCurrent = Functions::getExpForLevel($guild->getLevel());
        $expNext = Functions::getExpForLevel($guild->getLevel() + 1);
        $expLeft = bcsub($expNext, $guild->getExperience(), 0);
        $expLeftPercent = max(0, min(100, ($guild->getExperience() - $expCurrent) / ($expNext - $expCurrent) * 100));
                                                                    ...
                                                                    <table class="TableContent" width="100%" >
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td bgcolor="#F1E0C6" align="left">The guild was founded on ' . $config['server']['serverName'] . ' on ' . date("M d Y", $guild->getCreateDate()) . '</td>
                                                                            </tr>
                                                                            <div class="legacy-information" style="margin-bottom: 40px; overflow: auto;">
                                                                                <div class="badge_l">
                                                                                    <span class="caption">Lv. '. ($guild->getLevel()) .'</span>
                                                                                    <img src="./images/guild_levels/Legacy'. ($guild->getLevel()) .'.png" style="height: 50; width: 50px; margin-left: 10px; margin-top: 1px;">
                                                                                </div>
                                                                                <div class="bar_m">
                                                                                    <div style="height: 45px;width:100%;text-align:center;">
                                                                                        <h3 style="font-family: serif; font-weight: normal;">
                                                                                            Total experience gained: <strong><u>' . $guild->getExperience() . '</u></strong>.<br>
                                                                                            You need <strong><u> '.$expLeft.' experience</u></strong> to level up.	
                                                                                        </h3>
                                                                                    </div>
                                                                                    <div class="bar"> 
									                                                ...
									                                                ' . $expLeftPercent . '%
									                                                <div class="progress">
									                                                    <div class="progress-bar bg-guilds" role="progressbar" aria-valuenow="' . $expLeftPercent . '" aria-valuemin="0" aria-valuemax="100" style="width:' . $expLeftPercent . '%"></div>
									                                                </div>
									                                           </div>
                                                                                ...
                                                                                <div class="badge_r">
                                                                                    <span class="caption">Lv. '.($guild->getLevel()+1).'</span>
                                                                                    <img src="./images/guild_levels/Legacy'.($guild->getLevel()+1).'.png" style="height: 50; width: 50px; margin-left: 11px; margin-top: 2px;">
                                                                                </div>
                                                                            </div>
                                                                        </tbody>
                                                                    </table>
