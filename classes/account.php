...
class Account extends ObjectData
{
    ...
    public static $fields = array('id', 'name', 'password', 'secret', 'secret_status', 'premdays', 'coins', 'premium_points', 'lastday', 'email', 'key', 'create_ip', 'creation', 'page_access', 'location', 'rlname', 'birth_date', 'gender', 'email_new', 'email_new_time', 'email_code', 'next_email', 'last_post', 'flag', 'vote', 'loyalty_points', 'guild_points', 'player_sell_bank');
    public $data = array('name' => NULL, 'password' => NULL, 'secret' => NULL, 'secret_status' => 0, 'premdays' => 0, 'coins' => 0, 'premium_points' => 0, 'lastday' => 0, 'email' => NULL, 'key' => NULL, 'create_ip' => 0, 'creation' => NULL, 'page_access' => 0, 'location' => NULL, 'rlname' => NULL, 'birth_date' => NULL, 'gender' => NULL, 'email_new' => NULL, 'email_new_time' => 0, 'email_code' => NULL, 'next_email' => 0, 'last_post' => 0, 'flag' => NULL, 'vote' => 0, 'loyalty_points' => 0, 'guild_points' => 0, 'player_sell_bank' => 0);
    public $players;
    public $playerRanks;
    public $guildAccess;
    public $bans;
