...
class Guild extends ObjectData
{
    ...
    public static $fields = array('id',  'name', 'level', 'ownerid', 'experience', 'creationdata', 'motd', 'description', 'create_ip', 'guild_logo');
    public $data = array('name' => null, 'level' => null, 'ownerid' => null, 'experience' => null, 'creationdata' => null, 'motd' => null, 'description' => null, 'create_ip' => null, 'guild_logo' => null);
