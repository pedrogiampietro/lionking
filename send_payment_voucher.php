...
if ($config['site']['send_emails']) {
    ...
    $subject = 'Sua compra de ' . ($doubleStatus($price, $coinCount)) . ' ' . $config['sale']['productName'] . ' no website ' . $config['server']['serverName'];
    $mailDescription = "Recibo da sua compra de " . ($doubleStatus($price, $coinCount)) . " " . $config['sale']['productName'] . "<br/> no website " . $config['server']['serverName'];
    ...
    " . ($doubleStatus($price, $coinCount)) . "
    " . ($doubleStatus($price, $coinCount)) . " {$config['sale']['productName']}<br/><br/>
